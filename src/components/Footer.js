    ...
    <div className="footer-container">
      <section className="footer-subscription">
        ...
        <p className="footer-subscription-text">
          Hello!  My name is Michael Newton.  Apart from agricultural engineering, I'm a swimmer in the web3 seas, spending my free time exploring, developing, supporting, and evangelizing Web3 technology.  I am also a fresh resident of Surprise Arizona, from Berkeley California.
          <br></br>
