    ...
    <div className="footer-container">
      <section className="footer-subscription">
        ...
        <p className="footer-subscription-text">
          Hello!  My name is Mike Newton.  I'm swimmer in the realm of agricultural engineering who spends his free time exploring, developing, supporting, and evangelizing Web3 technology.  I am also a fresh resident of Surprise Arizona, from Berkeley California.
          <br></br>
